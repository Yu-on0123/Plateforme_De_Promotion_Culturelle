...
<div class="add-type-container">
    ...
    <div class="loading-overlay" id="loadingOverlay">
        ...
        <div class="loading-text">Création du type en cours...</div>
    </div>
    ...
    <div class="create-header">
        <div class="create-header-content">
            ...
            <h1 class="create-title">Nouveau Type</h1>
            <p class="create-subtitle">Ajoutez un nouveau type de média</p>
        </div>
    </div>
    ...
    <div class="create-form-container">
        ...
        <form action="{{ route('admin.types_medias.store') }}" method="POST" id="createForm">
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="suggestions-container">
                    ...
                    <div class="suggestions-grid">
                        <div class="suggestion-chip" data-type="Image" data-icon="🖼️">
                            <span>🖼️</span>
                            Image
                        </div>
                        <div class="suggestion-chip" data-type="Vidéo" data-icon="🎬">
                            <span>🎬</span>
                            Vidéo
                        </div>
                        <div class="suggestion-chip" data-type="Audio" data-icon="🎵">
                            <span>🎵</span>
                            Audio
                        </div>
                        <div class="suggestion-chip" data-type="Document" data-icon="📄">
                            <span>📄</span>
                            Document
                        </div>
                        <div class="suggestion-chip" data-type="PDF" data-icon="📑">
                            <span>📑</span>
                            PDF
                        </div>
                        <div class="suggestion-chip" data-type="Archive" data-icon="📦">
                            <span>📦</span>
                            Archive
                        </div>
                    </div>
                ...
                <div class="preview-section">
                    ...
                    <div class="preview-content">
                        <div class="type-badge" id="typePreview">
                            ...
                            <span id="previewText">Nouveau type</span>
                        </div>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    suggestionChips.forEach(chip => {
        chip.addEventListener('click', function() {
            ...
            const typeIcon = this.getAttribute('data-icon');
            
            nomInput.value = typeName;
            nomInput.dispatchEvent(new Event('input'));
            
            // Mettre à jour l'aperçu immédiatement
            previewText.textContent = typeName;
            previewIcon.textContent = typeIcon;
    ...
    function updatePreview(value) {
        ...
        if (trimmedValue) {
            ...
            typePreview.style.transform = 'scale(1.05)';
            setTimeout(() => {
                typePreview.style.transform = 'scale(1)';
            }, 150);
        } else {
    ...
    nomInput.addEventListener('focus', function() {
        ...
        this.parentElement.querySelector('.preview-section').style.background = 'rgba(59, 130, 246, 0.05)';
    });
    ...
    // Effet de saisie typewriter sur le placeholder
    const placeholderText = "Ex: Image, Vidéo, Audio, Document...";
    let placeholderIndex = 0;
    
    function typeWriter() {
        if (placeholderIndex < placeholderText.length) {
            nomInput.setAttribute('placeholder', placeholderText.substring(0, placeholderIndex + 1));
            placeholderIndex++;
